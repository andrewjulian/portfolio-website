            ...
            <div className="flex flex-col justify-between">
              <div>
                ...
                <p className="pt-2 text-white text-lg tracking-wide">
                  I'm currently looking for a new opportunity, my inbox is
                  always open. My focus is in creating websites and web
                  applications with a focus on the front-end or full-stack, but
                  I am also open to exploring other opportunities.
                </p>
                <p className="pt-2 text-white text-lg tracking-wide mb-5">
                  Whether you have a question or just want to say "Hi
                  &#128075;", use the form to send me a message and I will get
